    ...
    <footer class="flex flex-col items-center space-y-6 py-5 justify-center border-t border-gray-100">
        ...
        <div class="flex gap-9">
            <div class="bg-evogradientright h-full w-full p-3 rounded-full text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-facebook size-6" viewBox="0 0 16 16">
            ...
            <div class="bg-evogradientright h-full w-full p-3 rounded-full text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-twitter-x size-6" viewBox="0 0 16 16">
                    <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                </svg>
            </div>
            <div class="bg-evogradientright h-full w-full p-3 rounded-full text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-linkedin size-6" viewBox="0 0 16 16">
